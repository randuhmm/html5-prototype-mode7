...
class Engine extends minibot.event.EventDispatcher
{
  ...
  constructor(level)
  {
    ...
    level.tickSpeed = 800;
    level.matches = 20;
    level.candyTypes = [CandyType.A, CandyType.B, CandyType.C, CandyType.D];
...
Engine.UPDATE_ORDER = [];
Engine.UPDATE_ORDER.push(ComponentType.INPUT);
Engine.UPDATE_ORDER.push(ComponentType.LOGIC);
Engine.UPDATE_ORDER.push(ComponentType.GRID);
Engine.UPDATE_ORDER.push(ComponentType.PHYSICS);
Engine.UPDATE_ORDER.push(ComponentType.DISPLAY);
Engine.UPDATE_ORDER.push(ComponentType.SOUND);
